function C = coefs_hyb51f(data)
    ...
    C([144,159]) = ps(8)*tg(10)-ps(7)*tg(11);
    ...
    C(36) = -ps(1)*qs(1)+ps(2)*qs(2)+ps(1);
    C(46) = ps(1)*qs(1)-ps(2)*qs(2)-ps(1);
    C(31) = -ps(2)*qs(1)-ps(1)*qs(2)+ps(2);
    C(21) = ps(2)*qs(1)+ps(1)*qs(2)-ps(2);
    C(37) = -ps(3)*qs(3)+ps(4)*qs(4)+ps(3);
    C(47) = ps(3)*qs(3)-ps(4)*qs(4)-ps(3);
    C(32) = -ps(3)*qs(4)-ps(4)*qs(3)+ps(4);
    C(22) = ps(3)*qs(4)+ps(4)*qs(3)-ps(4);
    ...
    C(34) = -ps(7)*qs(8)-ps(8)*qs(7)+ps(8);
    C(24) = ps(7)*qs(8)+ps(8)*qs(7)-ps(8);
    ...
    C(42) = 2*ps(4)-2*ps(3)*qs(4)-2*ps(4)*qs(3);
    C(178) = ps(5)-ps(5)*qs(5)-ps(6)*qs(6);
    C(28) = 2*ps(5)-2*ps(5)*qs(5)+2*ps(6)*qs(6);
    C(173) = ps(6)-ps(6)*qs(5)+ps(5)*qs(6);
    ...
    C(82) = -2*tg(5)*qs(3)-2*qs(4)*tg(4)+2*ps(3)*qs(4)*tg(6)+2*ps(4)*tg(6)*qs(3);
    C(188) = tg(7)*qs(5)+qs(6)*tg(8)-ps(5)*tg(9)*qs(5)-ps(6)*qs(6)*tg(9);
    C(83) = -2*tg(8)*qs(5)-2*qs(6)*tg(7)+2*ps(5)*qs(6)*tg(9)+2*ps(6)*tg(9)*qs(5);
    C(183) = tg(8)*qs(5)-qs(6)*tg(7)+ps(5)*qs(6)*tg(9)-ps(6)*tg(9)*qs(5);
    C(84) = -2*tg(11)*qs(7)-2*qs(8)*tg(10)+2*ps(7)*qs(8)*tg(12)+2*ps(8)*tg(12)*qs(7);
    C(51) = -ps(1)*qs(2)*tg(3)-ps(2)*tg(3)*qs(1)+qs(2)*tg(1)+tg(2)*qs(1);
    C(86) = -ps(1)*tg(3)*qs(1)+ps(2)*qs(2)*tg(3)-qs(2)*tg(2)+tg(1)*qs(1);
    C(76) = ps(1)*tg(3)*qs(1)-ps(2)*qs(2)*tg(3)+qs(2)*tg(2)-tg(1)*qs(1);
    C(61) = ps(2)*tg(3)*qs(1)+ps(1)*qs(2)*tg(3)-qs(2)*tg(1)-tg(2)*qs(1);
    C(52) = -ps(3)*qs(4)*tg(6)-ps(4)*tg(6)*qs(3)+qs(4)*tg(4)+tg(5)*qs(3);
    C(62) = ps(3)*qs(4)*tg(6)+ps(4)*tg(6)*qs(3)-tg(5)*qs(3)-qs(4)*tg(4);
    C(87) = -ps(3)*tg(6)*qs(3)+ps(4)*qs(4)*tg(6)-qs(4)*tg(5)+tg(4)*qs(3);
    C(77) = ps(3)*tg(6)*qs(3)-ps(4)*qs(4)*tg(6)+qs(4)*tg(5)-tg(4)*qs(3);
    C(53) = -ps(5)*qs(6)*tg(9)-ps(6)*tg(9)*qs(5)+qs(6)*tg(7)+tg(8)*qs(5);
    ...
    C(90) = -ps(9)*tg(15)*qs(9)+ps(10)*qs(10)*tg(15)-qs(10)*tg(14)+tg(13)*qs(9);
    C(80) = ps(9)*tg(15)*qs(9)-ps(10)*qs(10)*tg(15)+qs(10)*tg(14)-tg(13)*qs(9);
