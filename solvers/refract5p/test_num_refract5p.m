...
for i = 1:N
    ...
    mon = @(x,y,z) [z*x^3,z*x^2*y,z*x*y^2,y^3*z,z^2*x^2,x*z^2*y,z^2*y^2,x*z^3,y*z^3,z^4,x^3,x^2*y,x*y^2,y^3,z*x^2,z*y^2,z^2*x,z^2*y,z^3,x^2,x*y,y^2,x*z,y*z,z^2,x,y,z,1];
