...
for i = 1:N
    ...
    for j=1:length(ww)
        ...
        y = yy(j);
        z = zz(j);
        m = [z^3*w^3,z^3*w^2*x,z^3*w*x^2,x^3*z^3,z^3*w^2*y,z^3*w*x*y,x^2*z^3*y,z^3*w*y^2,y^2*z^3*x,y^3*z^3,z^2*w^3,z^2*w^2*x,z^2*w*x^2,z^2*x^3,z^2*w^2*y,z^2*w*x*y,y*x^2*z^2,z^2*w*y^2,x*z^2*y^2,y^3*z^2,w^2*z^3,w*z^3*x,x^2*z^3,w*z^3*y,x*z^3*y,y^2*z^3,w^3*z,z*w^2*x,w*x^2*z,x^3*z,w^2*y*z,w*x*y*z,x^2*z*y,w*y^2*z,x*z*y^2,y^3*z,w^2*z^2,w*z^2*x,x^2*z^2,w*z^2*y,x*z^2*y,y^2*z^2,w*z^3,z^3*x,z^3*y,w^3,x*w^2,x^2*w,x^3,y*w^2,y*x*w,y*x^2,y^2*w,y^2*x,y^3,z*w^2,z*x*w,z*x^2,z*y*w,z*y*x,z*y^2,z^2*w,z^2*x,z^2*y,z^3,w^2,w*x,x^2,w*y,x*y,y^2,w*z,x*z,y*z,z^2,w,x,y,z,1];
        m = m/norm(m,'fro');
        M = [M; norm(C*m.','fro')];
    end
    M = sort(M);
