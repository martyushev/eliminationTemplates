...
for i = 1:N
    ...
    try
        ...
        [ww, xx, yy, zz] = std_relpose_7p_fr_1s_el_colpiv_sprs(C); % solve polynomial system
        tm = toc;
...
save(strcat(folder,'\_results\Tm_relpose_7p_fr_1s_el.mat'),'Tm_relpose_7p_fr_1s_el');
