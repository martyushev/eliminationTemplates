...
for i = 1:size(Z,2)
    Z1 = Z(:,i);
    [S1,R1,flag] = findPositions(Z1,data,S,R);
    if ~flag
...
function [S1,R1,flag] = findPositions(Z1,data,S,R)
    V = data{1};
    S1 = zeros(3,4);
    R1 = zeros(3,6);
    H1 = V(1:6)+V(10:15)*Z1(1)+V(19:24)*Z1(2)+V(28:33)*Z1(3)+V(37:42)*Z1(4);
    H1 = [H1(1) H1(2) H1(3); H1(2) H1(4) H1(5); H1(3) H1(5) H1(6)];
    b1 = V(7:9)+V(16:18)*Z1(1)+V(25:27)*Z1(2)+V(34:36)*Z1(3)+V(43:45)*Z1(4);
    [L,flag] = chol(H1);
    if ~flag
        L1 = L';
        S1(:,1) = L1\b1;
