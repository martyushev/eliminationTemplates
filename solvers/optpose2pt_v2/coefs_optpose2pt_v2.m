function C = coefs_optpose2pt_v2(data)
    ...
    C(90) = -2*U(2)*U(3)*u(3)*U(6)*U(5)*u(5)+2*U(2)*U(3)*u(3)*U(6)*U(5)*u(8)-2*U(2)*U(3)*u(4)*U(6)*U(5)*u(7)+2*U(2)*U(3)*U(6)*U(5)*u(7)*u(1)+U(2)^2*u(3)*U(6)^2*u(5)+U(2)^2*u(3)*U(5)^2*u(8)+U(2)^2*u(4)*U(6)^2*u(7)-U(2)^2*u(4)*U(5)^2*u(7)-U(3)^2*u(3)*U(6)^2*u(5)-U(3)^2*u(3)*U(5)^2*u(8)+U(3)^2*U(6)^2*u(7)*u(1)-U(3)^2*U(5)^2*u(7)*u(1)-2*U(2)^2*u(3)*U(6)*U(5)*u(7)+U(2)^2*u(4)*U(6)*U(5)*u(5)-U(2)^2*u(4)*U(6)*U(5)*u(8)-2*U(2)*U(3)*u(3)*U(6)^2*u(7)+2*U(2)*U(3)*u(3)*U(5)^2*u(7)+U(2)*U(3)*u(4)*U(6)^2*u(5)+U(2)*U(3)*u(4)*U(5)^2*u(8)-U(2)*U(3)*U(6)^2*u(5)*u(1)-U(2)*U(3)*U(5)^2*u(8)*u(1)+2*U(3)^2*u(3)*U(6)*U(5)*u(7)+U(3)^2*U(6)*U(5)*u(5)*u(1)-U(3)^2*U(6)*U(5)*u(8)*u(1);
    C(60) = -2*U(2)*U(3)*u(3)*U(6)*U(5)*u(5)+2*U(2)*U(3)*u(3)*U(6)*U(5)*u(8)-2*U(2)*U(3)*u(4)*U(6)*U(5)*u(7)+2*U(2)*U(3)*U(6)*U(5)*u(7)*u(1)-U(2)^2*u(3)*U(6)^2*u(8)-U(2)^2*u(3)*U(5)^2*u(5)-U(2)^2*U(6)^2*u(7)*u(1)+U(2)^2*U(5)^2*u(7)*u(1)+U(3)^2*u(3)*U(6)^2*u(8)+U(3)^2*u(3)*U(5)^2*u(5)-U(3)^2*u(4)*U(6)^2*u(7)+U(3)^2*u(4)*U(5)^2*u(7)-2*U(2)^2*u(3)*U(6)*U(5)*u(7)-U(2)^2*U(6)*U(5)*u(5)*u(1)+U(2)^2*U(6)*U(5)*u(8)*u(1)-2*U(2)*U(3)*u(3)*U(6)^2*u(7)+2*U(2)*U(3)*u(3)*U(5)^2*u(7)-U(2)*U(3)*u(4)*U(6)^2*u(8)-U(2)*U(3)*u(4)*U(5)^2*u(5)+U(2)*U(3)*U(6)^2*u(8)*u(1)+U(2)*U(3)*U(5)^2*u(5)*u(1)+2*U(3)^2*u(3)*U(6)*U(5)*u(7)-U(3)^2*u(4)*U(6)*U(5)*u(5)+U(3)^2*u(4)*U(6)*U(5)*u(8);
    C(72) = U(2)^2*u(3)*U(5)*u(7)+U(2)*u(3)*U(6)^2*u(7)-U(2)*u(3)*U(5)^2*u(7)-U(3)^2*u(3)*U(5)*u(7)-U(2)^2*u(4)*U(6)*u(7)-U(3)^2*U(6)*u(7)*u(1)+U(3)*u(3)*U(6)^2*u(5)+U(3)*u(3)*U(5)^2*u(8)-U(2)^2*u(3)*U(6)*u(5)-U(2)^2*u(4)*U(5)*u(5)+U(2)*U(6)^2*u(5)*u(1)+U(2)*U(5)^2*u(8)*u(1)+U(3)^2*u(3)*U(6)*u(5)-U(3)^2*U(5)*u(5)*u(1)-U(3)*U(6)^2*u(7)*u(1)+U(3)*U(5)^2*u(7)*u(1)+2*U(2)*U(3)*u(3)*U(6)*u(7)+U(2)*U(3)*u(4)*U(5)*u(7)-U(2)*U(3)*U(5)*u(7)*u(1)+U(2)*u(3)*U(6)*U(5)*u(5)-U(2)*u(3)*U(6)*U(5)*u(8)-2*U(3)*u(3)*U(6)*U(5)*u(7)+2*U(2)*U(3)*u(3)*U(5)*u(5)-U(2)*U(3)*u(4)*U(6)*u(5)+U(2)*U(3)*U(6)*u(5)*u(1)-2*U(2)*U(6)*U(5)*u(7)*u(1)-U(3)*U(6)*U(5)*u(5)*u(1)+U(3)*U(6)*U(5)*u(8)*u(1);
    C(48) = -U(2)^2*u(3)*U(6)*u(7)+U(2)^2*U(5)*u(7)*u(1)-U(2)*u(3)*U(6)^2*u(8)-U(2)*u(3)*U(5)^2*u(5)+U(3)^2*u(3)*U(6)*u(7)+U(3)^2*u(4)*U(5)*u(7)-U(3)*u(3)*U(6)^2*u(7)+U(3)*u(3)*U(5)^2*u(7)-U(2)^2*u(3)*U(5)*u(5)-U(2)^2*U(6)*u(5)*u(1)-U(2)*U(6)^2*u(7)*u(1)+U(2)*U(5)^2*u(7)*u(1)+U(3)^2*u(3)*U(5)*u(5)-U(3)^2*u(4)*U(6)*u(5)+U(3)*U(6)^2*u(8)*u(1)+U(3)*U(5)^2*u(5)*u(1)+2*U(2)*U(3)*u(3)*U(5)*u(7)-U(2)*U(3)*u(4)*U(6)*u(7)+U(2)*U(3)*U(6)*u(7)*u(1)-2*U(2)*u(3)*U(6)*U(5)*u(7)-U(3)*u(3)*U(6)*U(5)*u(5)+U(3)*u(3)*U(6)*U(5)*u(8)-2*U(2)*U(3)*u(3)*U(6)*u(5)-U(2)*U(3)*u(4)*U(5)*u(5)+U(2)*U(3)*U(5)*u(5)*u(1)-U(2)*U(6)*U(5)*u(5)*u(1)+U(2)*U(6)*U(5)*u(8)*u(1)+2*U(3)*U(6)*U(5)*u(7)*u(1);
