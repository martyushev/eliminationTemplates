...
% Monomial vector: [x^6, y^2*x^4, x^2*y^4, y^6, x^5, x^4*y, x^3*y^2, x^2*y^3, y^4*x, y^5, x^4, y*x^3, y^2*x^2, y^3*x, y^4, x^3, y*x^2, x*y^2, y^3, x^2, x*y, y^2, x, y, 1]

function [x, y] = std_pose_35pt_colpiv(C)
