...
Err_optpose2pt_v2_red = [];
Tm_optpose2pt_v2_red = [];
...
save(strcat(folder,'\_results\Err_optpose2pt_v2_red.mat'),'Err_optpose2pt_v2_red');
save(strcat(folder,'\_results\Tm_optpose2pt_v2_red.mat'),'Tm_optpose2pt_v2_red');

fprintf('Problem #20. Ave. runtime: %0.1f ms. Med. error: %0.2e\n',10^3*mean(Tm_optpose2pt_v2_red),median(Err_optpose2pt_v2_red));
