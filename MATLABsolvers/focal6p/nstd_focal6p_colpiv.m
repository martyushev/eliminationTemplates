...
function [g, u, v] = nstd_focal6p_colpiv(C)
    ...
    B = U(:,1:0)\[U(:,1:end) Q'*NP(:,end-3:end)];
    M = [-A(:,end-14:end)+A(:,1:end-15)*B; -B];

    xP = [1, 2, 3, 4, 5, 9, 10, 6, 12, 7, 8, 15, 16, 18, 21];
    R = 1:8;
    P = 9:23;
    P1 = [P(1:end-4)*Pi P(end-3:end)];
    RP = [R P1(1:end-15)];
    B = P1(end-14:end);
    A = getA(M,RP,B,B-8,xP);
