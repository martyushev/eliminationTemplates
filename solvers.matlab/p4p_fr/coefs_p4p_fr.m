function [C,U,dU] = coefs_p4p_fr(data)
    ...
    C(28) = M1(4)^2-M2(1)^2-M2(2)^2-M2(3)^2-M2(4)^2+M1(1)^2+M1(2)^2+M1(3)^2;
    C(60) = M1(8)^2-M2(5)^2-M2(6)^2-M2(7)^2-M2(8)^2+M1(5)^2+M1(6)^2+M1(7)^2;
    C(44) = M1(12)^2-M2(9)^2-M2(10)^2-M2(11)^2-M2(12)^2+M1(9)^2+M1(10)^2+M1(11)^2;
    C(80) = M1(15)^2+M1(16)^2-M2(13)^2-M2(14)^2-M2(15)^2-M2(16)^2+M1(13)^2+M1(14)^2;
    ...
    U = @(w,x,y,z)[w^2*x,w*x*y,y^2*x,w*x*z,z*y*x,z^2*x,w^2,x*w,y*w,x*y,y^2,z*w,x*z,y*z,z^2,w,x,y,z,1];
    dU = @(w,x,y,z)[[2*x*w,x*y,0,x*z,0,0,2*w,x,y,0,0,z,0,0,0,1,0,0,0,0];[w^2,y*w,y^2,z*w,y*z,z^2,0,w,0,y,0,0,z,0,0,0,1,0,0,0];[0,x*w,2*x*y,0,x*z,0,0,0,w,x,2*y,0,0,z,0,0,0,1,0,0];[0,0,0,x*w,x*y,2*x*z,0,0,0,0,0,w,x,y,2*z,0,0,0,1,0]];
